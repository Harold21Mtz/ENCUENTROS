                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    ...
                                    <label class="form-label">Subir imagen Principal <i style="color: #e20816" class="fa fa-upload"></i></label>
                                        <input type="file" id="image_upload" class="form-control input-skew" name="event_image" accept="image/jpeg, image/png" value="{{ old('event_image', $event->event_image) }}" @if ($errors->has('event_image')) autofocus @endif>
                                        @if($event->event_image)
                                        <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image) }}" alt="Imagen Principal" class="img-pequena">
                                        </p>
                                        @endif
                                    </div>
                                </div>
    ...
    <div style="overflow: hidden; height: auto; margin-top: -3%" class="modal fade" id="modal-update-{{$event->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 750px; margin-top: 50px">
            <div style="height: 600px; border: none;" class="modal-content">
                <div class="container-see" style="display: flex; align-items: center; padding: 0; border: none; flex-direction: column; margin-top: -1%; height: 600px; overflow: scroll;">
                    ...
                    <form id="update_form" method="POST" action="{{ route('events.update', $event->id) }}" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label required">Titulo del evento social</label>
                                    <input type="text" class="form-control input-skew" name="event_title" placeholder="Ingrese el titulo" maxlength="50" minlength="5" value="{{ old('event_title', $event->event_title) }}" @if ($errors->has('event_title')) autofocus @endif required>
                                    @if ($errors->has('event_title'))
                                    <div class="error-message">{{ $errors->first('event_title') }}</div>
                                    @endif
                                </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label required">Subir imagen Principal <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload" class="form-control input-skew" name="event_image" accept="image/jpeg, image/png" value="{{ old('event_image', $event->event_image) }}" @if ($errors->has('event_image')) autofocus @endif required>
                                    @if($event->event_image)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    ...
                                    <input type="file" id="image_upload_one" class="form-control input-skew" name="event_image_one" accept="image/jpeg, image/png" value="{{ old('event_image_one', $event->event_image_one) }}" @if ($errors->has('event_image_one')) autofocus @endif>
                                    @if($event->event_image_one)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_one) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 2 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_two" class="form-control input-skew" name="event_image_two" accept="image/jpeg, image/png" value="{{ old('event_image_two', $event->event_image_twp) }}" @if ($errors->has('event_image_two')) autofocus @endif>
                                    @if($event->event_image_two)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_two) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 3 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_three" class="form-control input-skew" name="event_image_three" accept="image/jpeg, image/png" value="{{ old('event_image_three', $event->event_image_three) }}" @if ($errors->has('event_image_three')) autofocus @endif>
                                    @if($event->event_image_three)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_three) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 4 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_four" class="form-control input-skew" name="event_image_four" accept="image/jpeg, image/png" value="{{ old('event_image_four', $event->event_image_four) }}" @if ($errors->has('event_image_four')) autofocus @endif>
                                    @if($event->event_image_four)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_four) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 5 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_five" class="form-control input-skew" name="event_image_five" accept="image/jpeg, image/png" value="{{ old('event_image_five', $event->event_image_five) }}" @if ($errors->has('event_image_five')) autofocus @endif>
                                    @if($event->event_image_five)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_five) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 6 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_six" class="form-control input-skew" name="event_image_six" accept="image/jpeg, image/png" value="{{ old('event_image_six', $event->event_image_six) }}" @if ($errors->has('event_image_six')) autofocus @endif>
                                    @if($event->event_image_six)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_six) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 7 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_seven" class="form-control input-skew" name="event_image_seven" accept="image/jpeg, image/png" value="{{ old('event_image_seven', $event->event_image_seven) }}" @if ($errors->has('event_image_seven')) autofocus @endif>
                                    @if($event->event_image_seven)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_seven) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="mb-3 input-ecu">
                                    <label class="form-label">Subir imagen Secundaria 8 <i style="color: #e20816" class="fa fa-upload"></i></label>
                                    <input type="file" id="image_upload_eight" class="form-control input-skew" name="event_image_eight" accept="image/jpeg, image/png" value="{{ old('event_image_eight', $event->event_image_eight) }}" @if ($errors->has('event_image_eight')) autofocus @endif>
                                    @if($event->event_image_eight)
                                    <p class="image-actual">Imagen actual: <img style="width: 100px; margin-left: 10px;" src="{{ asset('uploads/socialEvents/' . $event->event_image_eight) }}" alt="Imagen Principal" class="img-pequena">
                                    </p>
                                    @endif
                                </div>
                            </div>
    ...
    <div class="modal-dialog" style="min-width: 600px; height: 400px; margin-top: 62px">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <img style="max-height: 320px" id="modal-image" src="" alt="Event Image" class="img-fluid d-block mx-auto">
            </div>
        </div>
    </div>
</div>
