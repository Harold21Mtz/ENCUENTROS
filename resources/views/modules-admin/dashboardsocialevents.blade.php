...
{{--                                                          @if ($errors->has('event_description_one')) autofocus--}}
{{--                                                          @endif required--}}
{{--                                                          style="max-height: 125px; min-height: 125px">{{ old('event_description_one', $event->event_description_one) }}</textarea>--}}
{{--                                                @if ($errors->has('event_description_one'))--}}
{{--                                                    <div--}}
{{--                                                        class="error-message">{{ $errors->first('event_description_one') }}</div>--}}
{{--                                                @endif--}}
...
{{--                                                <textarea type="text" class="form-control input-skew"--}}
{{--                                                          name="event_description_two"--}}
{{--                                                          placeholder="Ingrese la descripcion dos" maxlength="1000"--}}
{{--                                                          minlength="5"--}}
{{--                                                          @if ($errors->has('event_description_two')) autofocus--}}
{{--                                                          @endif required--}}
{{--                                                          style="max-height: 125px; min-height: 125px">{{ old('event_description_two', $event->event_description_two) }}</textarea>--}}
{{--                                                @if ($errors->has('event_description_two'))--}}
{{--                                                    <div--}}
{{--                                                        class="error-message">{{ $errors->first('event_description_two') }}</div>--}}
{{--                                                @endif--}}
...
{{--                                                           class="form-control input-skew" name="event_image_one"--}}
...
{{--                                                    <label class="form-label">Subir imagen Secundaria 2 <i--}}
{{--                                                            style="color: #e20816" class="fa fa-upload"></i></label>--}}
{{--                                                    <input type="file" id="image_upload_two"--}}
{{--                                                           class="form-control input-skew" name="event_image_two"--}}
{{--                                                           accept="image/jpeg, image/png"--}}
{{--                                                           value="{{ old('event_image_two', $event->event_image_two) }}"--}}
{{--                                                           @if ($errors->has('event_image_two')) autofocus @endif>--}}
...
{{--                                                    <label class="form-label">Subir imagen Secundaria 6 <i--}}
{{--                                                            style="color: #e20816" class="fa fa-upload"></i></label>--}}
{{--                                                    <input type="file" id="image_upload_six"--}}
{{--                                                           class="form-control input-skew" name="event_image_six"--}}
{{--                                                           accept="image/jpeg, image/png"--}}
