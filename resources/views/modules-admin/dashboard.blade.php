...
<header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('login') }} class="logo d-flex align-items-center">
            <img src="assets/img/logo.jpg" style="max-height: 60px !important;"
                 height="80" alt="">
{{--            <span class="d-none d-lg-block">Events UFPSO</span>--}}
        </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Authors Area</span><i
        ...
        <a class="nav-link" data-bs-target="#forms-nav" href="{{ route('hotels_index') }}" aria-expanded="true">
            <i class="bi bi-journal-text"></i><span>Hotels</span>
        </a>

        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
                <i class="bi bi-layout-text-window-reverse"></i><span>Organization</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
                <i class="bi bi-bar-chart"></i><span>Program</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
                <i class="bi bi-gem"></i><span>Scientific</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
