@if($user)
    ...
    <main id="main" class="main">
                ...
                @foreach($hotels as $hotel)
                    <tr>
                        <td class="controls-table">
                            <div class="simon">
                                <div class="botones">
                                    <form id="update{{$hotel->id}}" method="POST"
                                    ...
                                    <form id="status{{$hotel->id}}" method="POST"
                                          action="{{ route('hotels.status', $hotel->id) }}">
                                        @csrf
                                        @method('PUT')

                                        <button type="button" onclick="updateStatus('{{$hotel->id}}')"
        ...
        <div style="overflow: hidden; height: auto; margin-top: -3%" class="modal fade" id="modal-register" tabindex="-1"
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 700px; margin-top: 50px">
                <div style="height: 520px; border: none; overflow: scroll" class="modal-content">
                        ...
                        <form id="register_form" method="POST" action="{{ route('hotels.store') }}" autocomplete="off"
                            ...
                            <div class="modal-body container">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="text" class="form-control input-skew" name="hotel_name"
                                                   placeholder="Ingrese el nombre del hotel" maxlength="100" minlength="5"
                                                   value="{{ old('hotel_name') }}"
                                                   @if ($errors->has('hotel_name')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            @if ($errors->has('hotel_contact_number'))
                                                <div
                                                    class="error-message">{{ $errors->first('hotel_contact_number') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="email" class="form-control input-skew" name="hotel_contact_email"
                                                   placeholder="Ingrese el correo de contacto" maxlength="100" minlength="5"
                                                   value="{{ old('hotel_contact_email') }}"
                                                   @if ($errors->has('hotel_contact_email')) autofocus @endif
                                                   required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="file" id="image_upload" class="form-control input-skew"
                                                   ...
                                                   @if ($errors->has('hotel_image')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label">Subir imagen Secundaria 1 <i style="color: #e20816"
                                            ...
                                            <input type="file" id="image_upload_secondary_one"
                                                   ...
                                                   @if ($errors->has('hotel_image_secondary_one')) autofocus @endif>
                                            @if ($errors->has('hotel_image_secondary_one'))
                                                <div
                                                    class="error-message">{{ $errors->first('hotel_image_secondary_one') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label">Subir imagen Secundaria 2 <i style="color: #e20816"
                                                                                                   class="fa fa-upload"></i></label>
                                            <input type="file" id="image_upload_secondary_two"
                                                   ...
                                                   @if ($errors->has('hotel_image_secondary_two')) autofocus @endif>
                                            @if ($errors->has('hotel_image_secondary_two'))
                                                <div
                                                    class="error-message">{{ $errors->first('hotel_image_secondary_two') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label">Subir imagen Secundaria 3 <i style="color: #e20816"
                                                                                                   class="fa fa-upload"></i></label>
                                            <input type="file" id="image_upload_secondary_three"
                                                   ...
                                                   @if ($errors->has('hotel_image_secondary_three')) autofocus @endif>
                                            @if ($errors->has('hotel_image_secondary_three'))
                                                <div
                                                    class="error-message">{{ $errors->first('hotel_image_secondary_three') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <textarea type="text" class="form-control input-skew" name="hotel_location"
                                                      placeholder="Ingrese la ubicación del hotel" maxlength="500" minlength="5"
                                                      @if ($errors->has('hotel_location')) autofocus
                                                      @endif required>{{ old('hotel_location') }}</textarea>
                ...
                <div style="overflow: hidden; height: auto; margin-top: -3%" class="modal fade"
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        Editar Hotel
                                ...
                                <form id="update_form" method="POST" action="{{ route('hotels.update', $hotel->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew" name="hotel_name"
                                                       ...
                                                       @if ($errors->has('hotel_name')) autofocus @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                <label class="form-label required">Correo de Contacto</label>
                                                <input type="email" class="form-control input-skew"
                                                       name="hotel_contact_email"
                                                       placeholder="Ingrese el correo de contacto" maxlength="100"
                                                       value="{{ old('hotel_contact_email', $hotel->hotel_contact_email) }}"
                                                       @if ($errors->has('hotel_contact_email'))autofocus @endif>
                                            </div>
                                        </div>
                                        <div style="display: flex">
                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" style="padding-left: 4px">
                                                <div class="mb-3 input-ecu">
                                                    ...
                                                    <input type="file" id="image_upload" class="form-control input-skew"
                                                           name="hotel_image" accept="image/jpeg, image/png"
                                                           value="{{ old('hotel_image', $hotel->hotel_image) }}"
                                                           @if ($errors->has('hotel_image')) autofocus @endif>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"
                                                ...
                                                <div class="mb-3 input-ecu" style="padding-left: 15px">
                                                    ...
                                                    <input type="file" id="image_upload" class="form-control input-skew"
                                                           name="hotel_image_secondary_one" accept="image/jpeg, image/png"
                                                           value="{{ old('hotel_image_secondary_one', $hotel->hotel_image_secondary_one) }}"
                                                           @if ($errors->has('hotel_image_secondary_one')) autofocus @endif>
                                                    @if($hotel->hotel_image_secondary_one)
                                                        <p class="image-actual">Imagen actual: <img
                                                                style="width: 100px; margin-left: 10px;"
                                                                src="{{ asset('storage/' . $hotel->hotel_image_secondary_one) }}"
                                                                alt="Imagen Secundaria 1" class="img-pequena">
                                                        </p>
                                    ...
                                    <div style="display: flex">
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" style="padding: 0">
                                            <div class="mb-3 input-ecu" style="padding-right: 15px">
                                                ...
                                                <input type="file" id="image_upload" class="form-control input-skew"
                                                       name="hotel_image_secondary_two" accept="image/jpeg, image/png"
                                                       value="{{ old('hotel_image_secondary_two', $hotel->hotel_image_secondary_two) }}"
                                                       @if ($errors->has('hotel_image_secondary_two')) autofocus @endif>
                                                @if($hotel->hotel_image_secondary_two)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('storage/' . $hotel->hotel_image_secondary_two) }}"
                                                            alt="Imagen Secundaria 2" class="img-pequena">
                                                    </p>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" style="padding: 0">
                                            <div class="mb-3 input-ecu" style="padding-left: 15px">
                                                ...
                                                <input type="file" id="image_upload" class="form-control input-skew"
                                                       name="hotel_image_secondary_three" accept="image/jpeg, image/png"
                                                       value="{{ old('hotel_image_secondary_three', $hotel->hotel_image_secondary_three) }}"
                                                       @if ($errors->has('hotel_image_secondary_three')) autofocus @endif>
                                                @if($hotel->hotel_image_secondary_three)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('storage/' . $hotel->hotel_image_secondary_three) }}"
                                                            alt="Imagen Secundaria 3" class="img-pequena">
                                                    </p>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <textarea type="text" class="form-control input-skew" name="hotel_location"
                                                          placeholder="Ingrese la ubicación del hotel" maxlength="500" minlength="5"
                                                          @if ($errors->has('hotel_location')) autofocus
                                                          @endif required>{{ old('hotel_description', $hotel->hotel_description) }}</textarea>
                                                @if ($errors->has('hotel_location'))
                                                    <div class="error-message">{{ $errors->first('hotel_location') }}</div>
                                                @endif
                                            </div>
