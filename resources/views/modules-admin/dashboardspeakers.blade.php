@if($user)
            ...
            @if(count($speakers) > 0)
                @foreach($speakers as $speaker)
                    <tr>
                                ...
                                <div class="botones">
                                    <form id="update{{$speaker->id}}" method="POST"
                                        ...
                                        <button type="button" onclick="showModalUpdate('{{$speaker->id}}')"
                                                class="custom-btn btn-1" data-speaker-id="{{$speaker->id}}" data-toggle="tooltip"
                        ...
                        <td>
                            <button class="button-ecu button-ecu-primary" onclick="showImage('{{$speaker->speaker_image_country}}')">
                                <span>Mostrar</span>
                                <i class="fa fa-image"></i>
                            </button>
                        </td>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            @if ($errors->has('speaker_university'))
                                                <div class="error-message">{{ $errors->first('speaker_university') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            @if ($errors->has('speaker_image_country'))
                                                <div class="error-message">{{ $errors->first('speaker_image_country') }}</div>
                                            @endif
                                        </div>
                                    </div>
                ...
                <div style="overflow: hidden; height: auto; margin-top: -1%" class="modal fade"
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        Editar Ponentes
                                ...
                                <form id="update_form" method="POST" action="{{ route('speakers.update', $speaker->id) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                                <div class="mb-3 input-ecu">
                                                    ...
                                                    <input type="text" class="form-control input-skew" name="speaker_title"
                                                           placeholder="Ingrese el titúlo del ponente" maxlength="20"
                                                           minlength="10" value="{{ old('speaker_title', $speaker->speaker_title) }}"
                                                           @if ($errors->has('speaker_title')) autofocus @endif required>
                                                    @if ($errors->has('speaker_title'))
                                                        <div class="error-message">{{ $errors->first('speaker_title') }}</div>
                                                    @endif
                                                ...
                                                <div class="mb-3 input-ecu">
                                                    ...
                                                    @if($speaker->speaker_profile)
                                                        <p class="image-actual">Imagen actual: <img
                                                                ...
                                                                src="{{ asset('storage/' . $speaker->speaker_profile) }}"
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                                <div class="mb-3 input-ecu">
                                                    ...
                                                    @if($speaker->speaker_image_country)
                                                        <p class="image-actual">Imagen actual: <img
                                                                style="width: 100px; margin-left: 10px;"
                                                                src="{{ asset('storage/' . $speaker->speaker_image_country) }}"
                                                                alt="Imagen Principal" class="img-pequena">
                                                        </p>
                                                    @endif
                                                </div>
    ...
    <script>
        ...
        function showImage(speaker_profile) {
            ...
            modalImage.src = "/storage/" + speaker_profile;
            $("#image-modal").modal('show');
        }

        function showImage(speaker_image_country) {
            const modalImage = document.getElementById("modal-image");
            modalImage.src = "/storage/" + speaker_image_country;
            $("#image-modal").modal('show');
        }
    </script>
    <script>
