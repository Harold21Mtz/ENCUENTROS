                ...
                @foreach($scientificscommiteeN as $scientificcommiteeN)
                    <tr>
                        <td class="controls-table">
                            <div class="simon">
                                <div class="botones">
                                    <form id="update{{$scientificcommiteeN->id}}" method="POST"
                                          action="{{ route('scientificcommitteeN.update', $scientificcommiteeN->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <button type="button" onclick="showModalUpdate('{{$scientificcommiteeN->id}}')"
                                                class="custom-btn btn-1"
                                                data-scientificcommiteeN-id="{{$scientificcommiteeN->id}}"
                                                data-toggle="tooltip" data-placement="left" title="Editar">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </button>
                                    </form>

                                    <form id="status{{$scientificcommiteeN->id}}" method="POST"
                                          action="{{ route('scientificcommitteeN.status', $scientificcommiteeN->id) }}">
                                        @csrf
                                        @method('PUT')
                                ...
                                <div class="botones3">
                                    <form id="delete{{$scientificcommiteeN->id}}" method="POST"
                                          action="{{route('scientificcommitteeN.delete',$scientificcommiteeN->id)}}">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 700px; margin-top: 86px">
                <div style="height: 300px; border: none;" class="modal-content">
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        <form id="register_form" method="POST" action="{{ route('scientificcommitteeN.store') }}"
        ...
        @if(count($scientificscommiteeN) > 0)
            @foreach($scientificscommiteeN as $scientificcommiteeN)
                ...
                <div style="overflow: hidden; height: auto; margin-top: -1%" class="modal fade"
                     id="modal-update-{{$scientificcommiteeN->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       value="{{ old('scientific_name', $scientificcommiteeN->scientific_name) }}"
                                                       @if ($errors->has('scientific_name')) autofocus @endif required>
                                                @if ($errors->has('scientific_name'))
                                                    <div
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       placeholder="Ingrese el titúlo del cientifico" maxlength="10"
                                                       minlength="2"
                                                       value="{{ old('scientific_title', $scientificcommiteeN->scientific_title) }}"
                                                       @if ($errors->has('scientific_title')) autofocus @endif required>
                                                @if ($errors->has('scientific_title'))
                                                    <div
                                                        class="error-message">{{ $errors->first('scientific_title') }}</div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       value="{{ old('scientific_university', $scientificcommiteeN->scientific_university) }}"
                                                       @if ($errors->has('scientific_university')) autofocus
                                                       @endif required>
                                                @if ($errors->has('scientific_university'))
                                                    <div
            ...
            @endforeach
        @endif
        <div class="pagination-scientificcommiteeN" style="text-align: end">
