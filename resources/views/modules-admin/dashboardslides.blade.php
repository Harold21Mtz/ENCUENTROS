                ...
                @foreach($slides as $slide)
                    <tr>
                        <td class="controls-table">
                            <div class="simon">
                                <div class="botones">
                                    <form id="update{{$slide->id}}" method="POST"
                                          action="{{ route('slides.update', $slide->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <button type="button" onclick="showModalUpdate('{{$slide->id}}')"
                                                class="custom-btn btn-1" data-slide-id="{{$slide->id}}"
                                                data-toggle="tooltip" data-placement="left" title="Editar">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </button>
                                    </form>

                                    <form id="status{{$slide->id}}" method="POST"
                                          action="{{ route('slides.status', $slide->id) }}">
                                        @csrf
                                        @method('PUT')

                                        <button type="button" onclick="updateStatus('{{$slide->id}}')"
                                                class="custom-btn {{($slide->status == 1) ? 'btn-2' : 'btn-3'}}"
                                                data-toggle="tooltip" data-placement="left"
                                                title="{{($slide->status == 1) ? 'Desactivar' : 'Activar'}}">
                                ...
                                <div class="botones3">
                                    <form id="delete{{$slide->id}}" method="POST"
                                          action="{{route('slides.delete',$slide->id)}}">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <td>
                            <button class="button-ecu button-ecu-primary"
                                    onclick="showImageLogo('{{$slide->conference_logo}}')">
                                <span>Mostrar</span>
                        ...
                        <td>
                            <button class="button-ecu button-ecu-primary"
                                    onclick="showImage('{{$slide->conference_image}}')">
                                <span>Mostrar</span>
                                <i class="fa fa-image"></i>
                            </button>
                        </td>
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 700px; margin-top: 80px">
                <div style="height: 450px; border: none; overflow: scroll" class="modal-content">
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        <form id="register_form" method="POST" action="{{ route('slides.store') }}" autocomplete="off"
                                ...
                                <div class="row" style="display: flex;">
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="text" class="form-control input-skew" name="conference_name"
                                                   placeholder="Ingrese el nombre de la conferencia" maxlength="70"
                                                   minlength="5" value="{{ old('conference_name') }}"
                                                   @if ($errors->has('conference_name')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="text" class="form-control input-skew" name="conference_date"
                                                   placeholder="Ingrese la fecha de la conferencia" maxlength="30"
                                                   minlength="5" value="{{ old('conference_date') }}"
                                                   @if ($errors->has('conference_date')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="text" class="form-control input-skew" name="university_name"
                                                   placeholder="Ingrese el nombre de la universidad" maxlength="70"
                                                   minlength="5" value="{{ old('university_name') }}"
                                                   @if ($errors->has('university_name')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="text" class="form-control input-skew" name="faculty_name"
                                                   placeholder="Ingrese el nombre de la facultad" maxlength="60"
                                                   minlength="5" value="{{ old('faculty_name') }}"
                                                   @if ($errors->has('faculty_name')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label required">Subir imagen del Logo <i
                                                    style="color: #e20816" class="fa fa-upload"></i></label>
                                            <input type="file" id="image_uploadlogo" class="form-control input-skew"
                                                   name="conference_logo" accept="image/jpeg, image/png"
                                                   value="{{ old('conference_logo') }}"
                                                   @if ($errors->has('conference_logo')) autofocus @endif required>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="file" id="image_upload" class="form-control input-skew"
                                                   name="conference_image" accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image') }}"
                                                   @if ($errors->has('conference_image')) autofocus @endif required>
                                            @if ($errors->has('conference_image'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="file" id="image_upload_secondary_one"
                                                   class="form-control input-skew" name="conference_image_secondary_one"
                                                   accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image_secondary_one') }}"
                                                   @if ($errors->has('conference_image_secondary_one')) autofocus @endif>
                                            @if ($errors->has('conference_image_secondary_one'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image_secondary_one') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="file" id="image_upload_secondary_two"
                                                   class="form-control input-skew" name="conference_image_secondary_two"
                                                   accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image_secondary_two') }}"
                                                   @if ($errors->has('conference_image_secondary_two')) autofocus @endif>
                                            @if ($errors->has('conference_image_secondary_two'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image_secondary_two') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            ...
                                            <input type="file" id="image_upload_secondary_three"
                                                   ...
                                                   name="conference_image_secondary_three"
                                                   accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image_secondary_three') }}"
                                                   @if ($errors->has('conference_image_secondary_three')) autofocus @endif>
                                            @if ($errors->has('conference_image_secondary_three'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image_secondary_three') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label">Subir imagen Secundaria 4 <i
                                                    style="color: #e20816" class="fa fa-upload"></i></label>
                                            <input type="file" id="image_upload_secondary_four"
                                                   class="form-control input-skew"
                                                   name="conference_image_secondary_four" accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image_secondary_four') }}"
                                                   @if ($errors->has('conference_image_secondary_four')) autofocus @endif>
                                            @if ($errors->has('conference_image_secondary_four'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image_secondary_four') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="mb-3 input-ecu">
                                            <label class="form-label">Subir imagen Secundaria 5 <i
                                                    style="color: #e20816" class="fa fa-upload"></i></label>
                                            <input type="file" id="image_upload_secondary_five"
                                                   class="form-control input-skew"
                                                   name="conference_image_secondary_five" accept="image/jpeg, image/png"
                                                   value="{{ old('conference_image_secondary_five') }}"
                                                   @if ($errors->has('conference_image_secondary_five')) autofocus @endif>
                                            @if ($errors->has('conference_image_secondary_five'))
                                                <div
                                                    class="error-message">{{ $errors->first('conference_image_secondary_five') }}</div>
                                            @endif
                                        </div>
                                    </div>
        ...
        @if(count($slides) > 0)
            @foreach($slides as $slide)
                ...
                <div style="overflow: hidden; height: auto; margin-top: -3%" class="modal fade"
                     id="modal-update-{{$slide->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        Editar Slide
                                ...
                                <form id="update_form" method="POST" action="{{ route('slides.update', $slide->id) }}"
                                    ...
                                    <div class="row" style="display: flex;">
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       placeholder="Ingrese el nombre de la conferencia" maxlength="70"
                                                       minlength="5"
                                                       value="{{ old('conference_name', $slide->conference_name) }}"
                                                       @if ($errors->has('conference_name')) autofocus @endif required>
                                                @if ($errors->has('conference_name'))
                                                    <div
                                                        class="error-message">{{ $errors->first('conference_name') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       placeholder="Ingrese la fecha de la conferencia" maxlength="30"
                                                       minlength="5"
                                                       value="{{ old('conference_date', $slide->conference_date) }}"
                                                       @if ($errors->has('conference_date')) autofocus @endif required>
                                                @if ($errors->has('conference_date'))
                                                    <div
                                                        class="error-message">{{ $errors->first('conference_date') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew"
                                                       ...
                                                       placeholder="Ingrese el nombre de la universidad" maxlength="70"
                                                       minlength="5"
                                                       value="{{ old('university_name', $slide->university_name) }}"
                                                       @if ($errors->has('university_name')) autofocus @endif required>
                                                @if ($errors->has('university_name'))
                                                    <div
                                                        class="error-message">{{ $errors->first('university_name') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="text" class="form-control input-skew" name="faculty_name"
                                                       placeholder="Ingrese el nombre de la facultad" maxlength="60"
                                                       minlength="5"
                                                       value="{{ old('faculty_name', $slide->faculty_name) }}"
                                                       @if ($errors->has('faculty_name')) autofocus @endif required>
                                                @if ($errors->has('faculty_name'))
                                                    <div
                                                        class="error-message">{{ $errors->first('faculty_name') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_uploadlogo" class="form-control input-skew"
                                                       name="conference_logo" accept="image/jpeg, image/png"
                                                       value="{{ old('conference_logo', $slide->conference_logo) }}"
                                                       @if ($errors->has('conference_logo')) autofocus @endif>
                                                @if($slide->conference_logo)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/logo/' . $slide->conference_logo) }}"
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload" class="form-control input-skew"
                                                       name="conference_image" accept="image/jpeg, image/png"
                                                       value="{{ old('conference_logo', $slide->conference_image) }}"
                                                       @if ($errors->has('conference_image')) autofocus @endif>
                                                @if($slide->conference_image)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/' . $slide->conference_image) }}"
                                                            alt="Imagen Principal" class="img-pequena">
                                                    </p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload_secondary_one"
                                                       class="form-control input-skew"
                                                       name="conference_image_secondary_one"
                                                       accept="image/jpeg, image/png"
                                                       value="{{ old('conference_image_secondary_one', $slide->conference_image_secondary_one) }}"
                                                       @if ($errors->has('conference_image_secondary_one')) autofocus @endif>
                                                @if($slide->conference_image_secondary_one)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/' . $slide->conference_image_secondary_one) }}"
                                                            alt="Imagen Principal" class="img-pequena">
                                                    </p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload_secondary_two"
                                                       class="form-control input-skew"
                                                       name="conference_image_secondary_two"
                                                       accept="image/jpeg, image/png"
                                                       value="{{ old('conference_image_secondary_two', $slide->conference_image_secondary_two) }}"
                                                       @if ($errors->has('conference_image_secondary_two')) autofocus @endif>
                                                @if($slide->conference_image_secondary_two)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/' . $slide->conference_image_secondary_two) }}"
                                                            alt="Imagen Principal" class="img-pequena">
                                                    </p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload_secondary_three"
                                                       ...
                                                       name="conference_image_secondary_three"
                                                       accept="image/jpeg, image/png"
                                                       value="{{ old('conference_image_secondary_three', $slide->conference_image_secondary_three) }}"
                                                       @if ($errors->has('conference_image_secondary_three')) autofocus @endif>
                                                @if($slide->conference_image_secondary_three)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/' . $slide->conference_image_secondary_three) }}"
                                                            alt="Imagen Principal" class="img-pequena">
                                                    </p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload_secondary_four"
                                                       class="form-control input-skew"
                                                       name="conference_image_secondary_four"
                                                       accept="image/jpeg, image/png"
                                                       value="{{ old('conference_image_secondary_four', $slide->conference_image_secondary_four) }}"
                                                       @if ($errors->has('conference_image_secondary_four')) autofocus @endif>
                                                @if($slide->conference_image_secondary_four)
                                                    <p class="image-actual">Imagen actual: <img
                                                            style="width: 100px; margin-left: 10px;"
                                                            src="{{ asset('uploads/slides/' . $slide->conference_image_secondary_four) }}"
                                                            alt="Imagen Principal" class="img-pequena">
                                                    </p>
                                                @endif
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                            <div class="mb-3 input-ecu">
                                                ...
                                                <input type="file" id="image_upload_secondary_five"
                                                       class="form-control input-skew"
                                                       name="conference_image_secondary_five"
                                                       accept="image/jpeg, image/png"
                                                       value="{{ old('conference_image_secondary_five', $slide->conference_image_secondary_five) }}"
                                                       @if ($errors->has('conference_image_secondary_five')) autofocus @endif>
        ...
        <div class="modal-dialog" style="min-width: 600px; height: 400px; margin-top: 62px">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <img style="max-height: 320px" id="modal-image" src="" alt="Slide Image"
