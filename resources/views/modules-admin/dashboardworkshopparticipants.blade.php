        ...
        @if(count($participants) > 0)
            @foreach($participants as $participant)
                <tr>
                            ...
                            <div class="botones">
                                <form id="update{{$participant->id}}" method="POST"
                                    ...
                                    <button type="button" onclick="showModalUpdate('{{$participant->id}}')"
                                            class="custom-btn btn-1" data-participant-id="{{$participant->id}}" data-toggle="tooltip"
                    ...
                    <tdstyle="text-align: justify;">{{$participant->participant_description}}</td>
                    <td>{{$participant->participant_university}}</td>
                    <td>
                        <button class="button-ecu button-ecu-primary" onclick="showImage('{{$participant->participant_profile}}')">
                            <span>Mostrar</span>
                            <i class="fa fa-image"></i>
                        </button>
                    </td>
                    <td>
                        <button class="button-ecu button-ecu-primary" onclick="showImage('{{$participant->participant_image_country}}')">
                            <span>Mostrar</span>
                            <i class="fa fa-image"></i>
                        </button>
                    </td>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 700px; top: 22%">
            <div style="height: 350px; border: none;" class="modal-content">
                <div style="display: flex; align-items: center; padding: 0; border: none; flex-direction: column;"
                    ...
                    <form id="register_form" method="POST" action="{{ route('participants.store') }}" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        <label class="form-label required">Nombre y Apellido del participante</label>
                                        <input type="text" class="form-control input-skew" name="participant_name"
                                               placeholder="Ingrese el nombre y apellido del participante" maxlength="200"
                                        ...
                                        @if ($errors->has('participant_name'))
                                            <div class="error-message">{{ $errors->first('participant_name') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        @if ($errors->has('participant_title'))
                                            <div class="error-message">{{ $errors->first('participant_title') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <textarea type="text" class="form-control input-skew" name="participant_presentation"
                                                  placeholder="Ingrese la presentación del participante" maxlength="200" minlength="10"
                                        ...
                                        @if ($errors->has('participant_presentation'))
                                            <div class="error-message">{{ $errors->first('participant_presentation') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <textarea type="text" class="form-control input-skew" name="participant_description"
                                                  placeholder="Ingrese la descripción del participante" maxlength="1000" minlength="10"
                                                  value="{{ old('participant_description') }}"
                                                  @if ($errors->has('participant_description'))autofocus
                                                  @endif required></textarea>
                                        @if ($errors->has('participant_description'))
                                            <div class="error-message">{{ $errors->first('participant_description') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <input type="text" class="form-control input-skew" name="participant_university"
                                               placeholder="Ingrese la Universidad del participante" maxlength="200"
                                               minlength="10" value="{{ old('participant_university') }}"
                                               @if ($errors->has('participant_university')) autofocus @endif required>
                                        @if ($errors->has('participant_university'))
                                            <div class="error-message">{{ $errors->first('participant_university') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        @if ($errors->has('participant_profile'))
                                            <div class="error-message">{{ $errors->first('participant_profile') }}</div>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-md modal-dialog-centered" style="max-width: 750px; top: 22%">
                    ...
                    <span style="font-size: 26px; padding-left: 16px" class="modal-title" id="exampleModalLabel"> <i
                        ...
                        Editar Participantes del WorkShop
                            ...
                            <form id="update_form" method="POST" action="{{ route('participants.update', $participant->id) }}"
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <input type="text" class="form-control input-skew" name="participant_name"
                                               placeholder="Ingrese el nombre y apellido del participante" maxlength="200"
                                               minlength="10" value="{{ old('participant_name', $participant->participant_name) }}" 
                                               @if ($errors->has('participant_name')) autofocus @endif required>
                                        @if ($errors->has('participant_name'))
                                            <div class="error-message">{{ $errors->first('participant_name') }}</div>
                                        @endif
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <input type="text" class="form-control input-skew" name="participant_title"
                                               placeholder="Ingrese el titúlo del participante" maxlength="20"
                                               minlength="10" value="{{ old('participant_title', $participant->participant_title) }}"
                                               @if ($errors->has('participant_title')) autofocus @endif required>
                                        @if ($errors->has('participant_title'))
                                            <div class="error-message">{{ $errors->first('participant_title') }}</div>
                                        @endif
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        <label class="form-label required">Presentación del participante</label>
                                        <textarea type="text" class="form-control input-skew" name="participant_presentation"
                                                  placeholder="Ingrese la dresentación del participante" maxlength="200" minlength="10"
                                                  @if ($errors->has('participant_presentation'))autofocus
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="mb-3 input-ecu">
                                        ...
                                        <input type="text" class="form-control input-skew" name="participant_university"
                                               placeholder="Ingrese la Universidad del participante" maxlength="200"
                                               minlength="10" value="{{ old('participant_university', $participant->participant_university) }}"
                                               @if ($errors->has('participant_university')) autofocus @endif required>
                                        @if ($errors->has('participant_university'))
                                            <div class="error-message">{{ $errors->first('participant_university') }}</div>
                                        @endif
