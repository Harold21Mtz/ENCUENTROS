                            ...
                            <div class="card" style="width: 18rem;">
                                <a href="{{$publishing->link_journal}}" target="_blank">
                                    <img class="card-img-top zoom"
                                         src="{{ asset('uploads/revistas/' . $publishing->image_journal) }}"></a>
