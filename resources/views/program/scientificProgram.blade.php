...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container">
            <p style="font-size:24px !important"> The schedule for oral presentations can be viewed at the following
                link :
                    ...
                    @if($scientificprogram->status == 1)
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 pt-4 pt-lg-0 content">
                                ...
                                <h2 style="background-color: #0D47A1;color:#fff; margin-bottom:0"
                                    class="breadcrumbs text-center">{{$scientificprogram->name_program}}</h2>
