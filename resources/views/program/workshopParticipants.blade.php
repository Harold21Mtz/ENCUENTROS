                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    @foreach($participants as $participant)
                        @if($participant->status == 1)
                            <div class="member">
                                <img src="{{ asset('storage/' . $participant->participant_profile) }}"
                                ...
                                <div class="social">
                                    <img src="{{ asset('storage/' . $participant->participant_image_country) }}"
                                         style="border-radius: 0; width: 40px;"><br>
                                    <a href="" data-toggle="modal" data-target="#modal{{$participant->id}}"><i style="font-size: 28px;"
                                                                                                           class="icofont-search-job"></i></a>
                                </div>
                            </div>
                </div>

                <div class="modal fade" id="modal{{$participant->id}}" tabindex="-1" aria-labelledby="modalLabel12234"
                     aria-hidden="true">
