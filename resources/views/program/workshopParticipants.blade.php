                    ...
                    @foreach($participants as $participant)
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            @if($participant->status == 1)
                                <div class="member">
                                    <img src="{{ asset('uploads/participants/' . $participant->participant_profile) }}"
                                    ...
                                    <div class="social">
                                        ...
                                        <a href="" data-toggle="modal" data-target="#modal{{$participant->id}}"><i
                                                style="font-size: 28px;" class="icofont-search-job"></i></a>
                                    </div>
                                </div>


                                <div class="modal fade" id="modal{{$participant->id}}" tabindex="-1"
                                     aria-labelledby="modalLabel12234" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="modalLabel12234">{{$participant->participant_name}}
