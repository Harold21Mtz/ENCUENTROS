                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            @if($speaker->status == 1)
                                <div class="member">
                                    ...
                                    <div class="social">
                                        <img src="{{ asset('uploads/countries/' . $speaker->speaker_image_country) }}"
                                             style="border-radius: 0; width: 40px;"><br>
                                        <a href="" data-toggle="modal" data-target="#modal{{$speaker->id}}"><i
                                                style="font-size: 28px;" class="icofont-search-job"></i></a>
                                    </div>
                                </div>

                                <div class="modal fade" id="modal{{$speaker->id}}" tabindex="-1"
