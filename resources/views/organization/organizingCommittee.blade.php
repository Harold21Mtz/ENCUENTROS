    ...
    <div class="container">
      ...
      <div class="row" style="gap: 5px;">
        <div class="col-lg-12 col-md-6 ">
          ...
          <h4 style="margin-bottom:0px;cursor:pointer" data-toggle="modal" data-target="#showmodal{{$organizingcommitee->id}}">{{$organizingcommitee->organizer_charge}}<br>{{$organizingcommitee->organizer_name}}, {{$organizingcommitee->organizer_title}}</h4>
          <i class="icofont-circled-right" style="color: #0D47A1;margin-left:15px"></i> {{$organizingcommitee->organizer_university}}
          <!-- Modal -->
          <div class="modal fade" id="showmodal{{$organizingcommitee->id}}" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">

                  <h5 class="modal-title" id="label">{{$organizingcommitee->organizer_charge}} <br>{{$organizingcommitee->organizer_name}}, {{$organizingcommitee->organizer_title}}</h5>
