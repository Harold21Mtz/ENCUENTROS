            ...
            @foreach($scientificscommiteeN as $index => $scientificcommiteeN)
                @if($scientificcommiteeN->status == 1)
                    <div class="col-lg-6 col-md-6">
                        <h4 style="margin-bottom:0px;cursor:pointer" data-toggle="modal" data-target="#modal{{$scientificcommiteeN->id}}">{{$scientificcommiteeN->scientific_name}}, {{$scientificcommiteeN->scientific_title}}
                        </h4>
                        <i class="icofont-circled-right" style="color: #0D47A1;margin-left:15px"></i> {{$scientificcommiteeN->scientific_university}}

                        <!-- Modal -->
                        <div class="modal fade" id="modal{{$scientificcommiteeN->id}}" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel8">{{$scientificcommiteeN->scientific_name}}, {{$scientificcommiteeN->scientific_title}}</h5>
