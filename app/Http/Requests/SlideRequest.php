    ...
    public function rules(): ?array
    {
        ...
        if ($this->isMethod('post')) {
            ...
            return [
                ...
                'conference_date' => 'required|string|max:30',
                'university_name' => 'required|string|max:70',
                'conference_logo' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image_secondary_one' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image_secondary_two' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image_secondary_three' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image_secondary_four' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'conference_image_secondary_five' => "sometimes|mimes:png,jpg|file|max:{$maxSize}",
                'registerBy' => 'required|string|max:30',
            ];
        }
